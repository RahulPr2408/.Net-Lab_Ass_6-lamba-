...
namespace ConsoleApp18jan2022
{
    ...
    public class TestGenericMethods
    {
        public static void Main(string[] args)
        {
            ...
            emplist.Add(new Employee(0011, 12000000, "Jay", Designations.CEO));

            emplist.Add(new Employee(2001, 501000, "Aish", Designations.sde));

            emplist.Add(new Employee(2004,20999,"Kezal",Designations.CEO));

            emplist.Add(new Employee(4001,78000,"Rushita",Designations.sde));

            emplist.Add(new Employee(6006,900000,"Yash",Designations.CFO));
